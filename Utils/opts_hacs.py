...
def parse_opt(parser):
    ...
    parser.add_argument(
        '--video_anno',
        type=str,
        default='Evaluation/hacs/annot/HACS_segments_v1.1.1.json')
    # parser.add_argument(
    #     '--detad_anno',
    #     type=str,
    ...
    parser.add_argument(
        ...
        default="Evaluation/hacs/annot/HACS_segments_v1.1.1.json")
    parser.add_argument(
        '--vlevel_cls_res',  # cls_res
        type=str,
        default="Evaluation/hacs/annot/hacs_cls_tsm.npy")
    parser.add_argument(
        '--val_vids',
        type=str,
        default="Evaluation/hacs/annot/val_vids.txt")
    parser.add_argument(
        '--test_vids',
        type=str,
        default="Evaluation/hacs/annot/test_vids.txt")
    parser.add_argument(
        '--hacs_names',  # anet_names
        type=str,
        default="Evaluation/hacs/annot/action_name.csv")
    parser.add_argument(
        '--hacs_classes',
        type=str,
        default="Evaluation/activitynet/annot/anet_classes_idx.json")
    parser.add_argument(
        '--infer', type=str, default="val", choices=['val', 'test'])
    ...
    parser.add_argument(
        ...
        type=str,
        choices=['all', 'alter_window', 'thr_action', 'unif_rand', 'start_end'])
